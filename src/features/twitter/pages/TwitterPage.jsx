    ...
    <div className="min-h-screen bg-linear-to-br from-slate-950 via-purple-950 to-slate-950">
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          ...
          <h1 className="text-4xl font-black text-transparent bg-linear-to-r from-slate-400 to-slate-200 bg-clip-text">
            Twitter
          </h1>
          <div className="w-20" />
        </div>

        <SearchBar onSearch={handleSearch} placeholder="Search tweets..." />
        ...
        {filteredPosts.length === 0 && (
          <div className="text-center py-20">
            <p className="text-xl text-muted-foreground font-black">No tweets found</p>
          </div>
        )}
      </div>
    </div>
